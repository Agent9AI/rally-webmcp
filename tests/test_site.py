...
class TestProductSite(unittest.TestCase):
    ...
    def test_webmcp_starts_and_opens_real_rally_jobs(self):
        ...
        self.assertIn('data-open-research-reserve', admin_html)
        self.assertIn('Research reserve', admin_html)
        self.assertIn('researchShortcut.addEventListener("click"', admin_app)
        self.assertIn('setAssistantSetupCollapsed(false)', admin_app)
